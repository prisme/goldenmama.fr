...
var _SplitText = _interopRequireDefault(require("./gsap-bonus/SplitText"));
...
_domLoaded.default.then(() => {
  ...
  mama.addEventListener('mouseleave', event => {// tlMama.stop()
    // tlMama.seek(0)
...
},{"./gsap-bonus/SplitText":14,"dom-loaded":1,"gsap/TweenMax":11,"is-touch-device":13}]},{},[15]);
